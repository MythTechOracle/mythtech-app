 ...
 * Dependency root for: fixtures -> data -> adapter -> components -> host.
 */

/** @typedef {"low"|"medium"|"high"} Severity */
/** @typedef {"up"|"down"|"flat"} DeltaDirection */
/** @typedef {"low"|"moderate"|"mixed"|"healthy"|"elevated"|"improving"|"degraded"|"contained"|"watch"|"hardening"} MetricStatus */
